...
例：
```
The best way for a teacher to let student become interested in a subject is to help them know how to use it in their lives outside school.
```
Disagree   
    ...
    * 非谓语的功能：  
        ...
        表伴随：  
            * 1. 非谓语和主语是伴随关系  
                ...
                She works hard, wishing to be admitted by Harvard.  
            * 2.非谓语和整个句子是伴随关系  
                Internet has been applied in education, making education easier.(= which makes education easier.)
...
5. 过去要用过去式
    In the past, we were unable to growing anything in water.  
...
2. 句子层面     
    ...
    短句变长句核心技巧：  
        ...
        2. 各种从句（定语从句）
        ```
        Traveling exposes one to various people. He can communicate and interact with them. This is beneficial for his interpersonal skills. 
        
        
        Traveling exposes one to various people, with whom he can communicate and interact, which is beneficial for his interpersonal skills. 
        ```
    ...
    **不要用有生命的名词或人称代词开头**
       ...
       4. 介词短语
       ```
       Without surprise, the policy was banned.
       ```
       5. 动名词
       ```
       ...
       6. it形式主语
       ```
       It is not surprising that the policy was banned.
       ```
       ```
       Tips:
    ...
    The close connection between energy and population is increasely recognized.
    ```
    2. 少用 IF， 口语化太重
    ```
...
1. 倒装句
    1. 全倒装
        ...
        2. 形容词短语置于句首 + 倒装
            ```
            Contrary to / Coincident with the opinion of many people is my agreement with the idea that college students should live outside campus.
            ```
    ...
    2. 半倒装
        1. 否定词开头 + 半倒装  
            ```
            Never will I forget the experience that I was cheated by my tour guide to by something unnecessary but that he strongly recommended to us.
            ```
            ```
            否定词：
            not, no, never, neither, nor, seldom, rarely, barely, scarcely, hardly, little, under no circumstances, on no occasion, in no case
            ```
        ...
        3. adj + as/though 在句首
            ```
            Considerable though the advantages (that owing a business enjoys) are, they can not compete with the benefits that working for others bring out.
            ```
2. 强调句
    1. It is ··· that
        ```
        It is new friends that bring fresh knowledge and different views to you.
        ```
        ```
...
3. 虚拟语气
    ...
    2. 与过去情况相反  
        ...
        ```
        If my father had not founded his own business, he would not have been so successful.
        ```
        ```
        倒装+虚拟：
        Had my father not founded his own business, he would not have been so successful.
        ```
    3. 对将来情况的主观推测  
        were to do
    4. wish 和建议
...
5. The more 句型  
    The + 比较级, the + 比较级
    ```
    The more time we spend on playing computer games, the less time we have for study.
    ```
6.  插入语  插入句  
    1. 转折
    ```
    however = nevertheless = northless = notwithstanding, conversely
    ```
    2. 承接
    ```
