...
例：
```
The best way for a teacher to let student become interested in a subject is to help them know how to use it in their lives ouside school.
```
Disagree   
...
3. 虚拟语气
    ...
    2. 与过去情况相反  
        ...
        ```
        If my father had not founded his own bussiness, he would not have been so successful.
        ```
        ```
        倒装+虚拟：
        Had my father not founded his own bussiness, he would not have been so successful.
        ```
    3. 对将来情况的主观推测  
        were to do
    4. wish 和建议
